...
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代码生成业务表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 543 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_hidden_trouble
-- ----------------------------
...
CREATE TABLE `rsm_hidden_trouble`  (
  ...
  `trouble_classify` int NULL DEFAULT 0 COMMENT '隐患分类 0-地质隐患 1-设备隐患 2-环境隐患 3-生产隐患 4-其他',
  `source` tinyint NULL DEFAULT NULL COMMENT '隐患来源 0-随手拍 1-上传',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '隐患表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_patrol_list
-- ----------------------------
...
CREATE TABLE `rsm_patrol_list`  (
  ...
  `principal_id` bigint NOT NULL COMMENT '安全员id',
  ...
  `status` tinyint NULL DEFAULT 0 COMMENT '状态 0-未开始 1-巡查中 2-已结束',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡查清单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_patrol_point
-- ----------------------------
DROP TABLE IF EXISTS `rsm_patrol_point`;
CREATE TABLE `rsm_patrol_point`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '巡查点id',
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡查点表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_risk
-- ----------------------------
...
CREATE TABLE `rsm_risk`  (
  ...
  `risk_relate_id` bigint NULL DEFAULT 0 COMMENT '风险关联id，作为保留字段，如果没有设备表和生产现场表那么这个字段仅在风险类型为作业风险时有用，用于关联作业表',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '风险库表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_snapshot
-- ----------------------------
DROP TABLE IF EXISTS `rsm_snapshot`;
CREATE TABLE `rsm_snapshot`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '随手拍id',
  ...
  `handler_id` bigint NULL DEFAULT NULL COMMENT '审批人id',
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '随手拍问题表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_task
-- ----------------------------
...
CREATE TABLE `rsm_task`  (
  ...
  `approval_status` tinyint(1) NULL DEFAULT 0 COMMENT '审核状态（1通过 0未审核 2未通过）',
  ...
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '备注（审核意见）',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '作业表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for rsm_unverified_risk
-- ----------------------------
DROP TABLE IF EXISTS `rsm_unverified_risk`;
CREATE TABLE `rsm_unverified_risk`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '待查项id',
  ...
  `position` bigint NOT NULL COMMENT '巡查点id',
  `status` tinyint NULL DEFAULT 0 COMMENT '状态 0-未处理  1-未发现隐患 2-发现隐患',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '备注',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '创建人',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '风险待查项表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 226 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
