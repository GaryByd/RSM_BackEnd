...
public class AliOssUtil {
    ...
    private static final String ACCESS_KEY_ID = "LTAI5tKasb1FqhTuPE4UuJLd";
    private static final String ACCESS_KEY_SECRET = "UB8tuzl7YsQJ18r0ggGojZLpboyjRv";
    // 填写Bucket名称，例如examplebucket。
    public static final String BucketName = "rsm-ksaq";
